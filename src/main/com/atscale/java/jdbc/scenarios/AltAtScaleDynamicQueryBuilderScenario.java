...
public class AltAtScaleDynamicQueryBuilderScenario {
    private static final Logger SESSION_LOGGER = LoggerFactory.getLogger("SqlLogger");
    private static final Logger LOGGER = LoggerFactory.getLogger(AltAtScaleDynamicQueryBuilderScenario.class);

    public AltAtScaleDynamicQueryBuilderScenario() {
        super();
    }
